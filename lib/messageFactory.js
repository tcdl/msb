"use strict";
var generateId_1 = require("./support/generateId");
var serviceDetails_1 = require("./support/serviceDetails");
var _ = require('lodash');
var INSTANCE_ID = serviceDetails_1.serviceDetails.instanceId;
...
messageFactory.createBaseMessage = function (config, originalMessage) {
    ...
    var message = {
        id: generateId_1.generateId(),
        correlationId: generateId_1.generateId(),
...
messageFactory.createAck = function (config) {
    return {
        responderId: generateId_1.generateId(),
...
messageFactory.createMeta = function (config, originalMessage) {
    ...
    return {
        ...
        publishedAt: null,
        durationMs: null,
        serviceDetails: serviceDetails_1.serviceDetails
    };
};
