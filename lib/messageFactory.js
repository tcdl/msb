...
function createDirectedMessage(config, originalMessage) {
    var message = createBaseMessage(config, originalMessage);
...
function createBroadcastMessage(config, originalMessage) {
    var meta = createMeta(config, originalMessage);
    var message = createDirectedMessage(config, originalMessage);
    message.meta = meta;
    return message;
}
